    ...
    <div class="container mt-3">
        <form action="" method="post">
            ...
            <div class="form-group">
                ...
                <input type="password" name="cust_login_passward" id="" class="form-control" value="<?php echo $customer['cust_login_passward'] ?>">
            </div> 
            ...
            <input type="submit" value="Update Customer <?php echo $customer['cust_fname']; ?>" name="update" class="btn btn-primary">
